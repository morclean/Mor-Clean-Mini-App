...
const prettyService = (s = "") => {
  ...
  // If it looks like a Square ID (long, all-caps letters/numbers), ignore it
  if (/^[A-Z0-9]{10,}$/.test(raw)) return ""; // hide the pill
  const label = raw.replace(/_/g, " ").toLowerCase();
  return label ? label.replace(/\b\w/g, (c) => c.toUpperCase()) : ""; // Title Case
